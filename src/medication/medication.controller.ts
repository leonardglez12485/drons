...
import { fileFilter, fileNamer } from '../common/helpers/index';
...
export class MedicationController {
  ...
  @Get('img/:term')
  async findImage(@Param('term') term: string, @Res() res: Response) {
    return this.medicationService.findImage(term, res);
  }

  @Patch(':term')
  update(@Param('term') term: string, @Body() dto: UpdateMedicationDto) {
